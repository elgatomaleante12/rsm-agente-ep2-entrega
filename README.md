...
3. Ejecuta `Crear entorno virtual`.
4. Ejecuta `Instalar dependencias`.
5. Ejecuta `Inicializar base de datos`.
6. Ejecuta `Ejecutar API`.
7. Abre tu navegador y visita `http://127.0.0.1:8000`.

Si quieres acceder desde otro equipo en la misma red, usa `http://<IP_DEL_EQUIPO>:8000`.
...
```powershell
cd c:\Users\joaquin\Documents\Codex\2026-05-30\files-mentioned-by-the-user-ep2\rsm-agente-ep2-entrega
py -3 -m venv .venv
